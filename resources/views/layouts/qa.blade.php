...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="{{route('inicio')}} " class="logo"><img alt="Logo" src="{{asset('assets/images/logo.png')}}" /> <span>QA</span></a>
        </div>
					...
					<li class="submenu">
                        <a href="#" id="sub_evaluate" ><i class="fa fa-fw fa-file-text-o"></i> <span> Evaluate </span> <span class="active menu-arrow"></span></a>
                            <ul class="list-unstyled">
								<li><a href="{{route('qa.aftha.form')}} " id="sub_evaluate_aftha" >Aftha</a></li>
								<li><a href="forms-select2.html">DirecTV</a></li>
			...
			<ion-icon name="contacts"></ion-icon>
					...
					<li class="submenu">
                        <a href="#" id="sub_scores" ><i class="fa fa-fw fa-calendar-check-o"></i> <span> Scores </span> <span class="active menu-arrow"></span></a>
                            <ul class="list-unstyled">
								<li><a href="{{route('qa.aftha.score')}} "  id="sub_evaluate_aftha" >All Campaigns</a></li>
								<li><a href="{{route('qa.aftha.form')}} " id="sub_evaluate_aftha" >Aftha</a></li>
