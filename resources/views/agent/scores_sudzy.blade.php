...
@section('title', 'All Scores Sudzy')
...
<div class="row">
    <div class="col-xl-12">
            <div class="breadcrumb-holder">
                    <h1 class="main-title float-left"> <a href="{{route('agent.sudzy.score')}} "> Scores</a></h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fa fa-table"></i>Sudzy scores</h3>
             ...
             <div class="modal-body">
                <div class='row'>
                    ...
                    <div class='form-group col-md-6' >
                        <label for="Q1" class='text-primary'>1.- Was screening done properly(3 questions)</strong></label>
                    </div>
                    <div class='form-group col-md-6' >
                    ...
                    <div class='form-group col-md-6' >
                        <label for="Q8" class='text-primary'>8.- Did the agent rebuttal and close (min twice).</label>
                    </div>
                    <div class='form-group col-md-6' >
                    ...
                    <div class='form-group col-md-6' >
                        <label for="Q11" class='text-primary'>11.- Did agent send email/SMS when needed..</label>
                    </div>
                </div>
                <div>
...
<script>
    function showComments(val) {
        $.ajax({url: "getcommentsSudzy/"+val, success: function(result){
...
<script>
    ...
    var table = $('#scoreTable').DataTable( {
        ...
        "ajax": {
            "url": "getScoresSudzy/data.json/all"
        },
        // "ajax": {
