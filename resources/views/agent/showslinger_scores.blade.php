...
<div class="row">
    <div class="col-xl-12">
            <div class="breadcrumb-holder">
                    <h1 class="main-title float-left"> <a href="{{route('agent.aftha.score')}} "> Scores</a></h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">						
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fa fa-table"></i>ShowSlinger campaign</h3>
         ...
         <div class="modal-content">
           ...
           <span aria-hidden="true">&times;</span>
             ...
             <div class="modal-body">
                 <div class='row'>
                    <div class="col-md-12">
                        <label for="phone" class="text-primary">Phone number:
                        <p id="c1"></p></label>
                    </div>
                    <div class="col-md-12">
                        <label for="phone" class="text-primary" >URL:
                        <p id="c2"></p></label>
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q1" class='text-dark' >1.-Greeting: Must have an immediate, clear greeting with agent and business name: <strong class="text-danger">olsi</strong>
                    <p id="c3" class="text-secondary">No comments</p></label>
                    
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q2" class='text-dark'>2.-Fluently explained the AFTHA Program and Credit Specialist. As well as what they can do for the customers.:
                    <p id="c4" class="text-secondary">No comments</p></label>
                    
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q3" class='text-dark'>3.-Asked all required questions? :
                    <p id="c5" class="text-secondary">No comments</p></label>
                    
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q4" class='text-dark'>4.-Control the call, while answering the customer's (relevant) questions thoroughly.:<p id="c6" class="text-secondary">No comments</p></label>
                    
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q5" class='text-dark'>5.-Did the agent Actively Listen to Client?:
                    <p id="c7" class="text-secondary">No comments</p></label>
                    
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q6" class='text-dark'>6.-Was the call transferred?
                    <p id="c8" class="text-secondary">No comments</p></label>
                    
                    </div>
                    <div class='form-group col-md-6' >
                    <label for="Q7" class='text-dark'>7.-Did the Agent give a description of the client's situation and goals to the credit specialist?
