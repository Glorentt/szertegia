...
<div class="row">
  <div class="col-xl-12">
    <div class="breadcrumb-holder">
      <h1 class="main-title float-left">Homeowners</h1>
      ...
      <div class="card col-md-12 col-lg-12 col-xl-12">
        <div class="card-header">
          <h3><i class="fa fa-check-square-o"></i> Homeowners Call Monitoring</h3>
          Evaluation for Homeowners Call Monitoring
        </div>

        <div class="card-body ">
          <form class="was-validated row" method="POST" action="{{route('admin.homeowners.store')}} ">
            ...
            <div class="col-md-6 col-lg-6 col-xl-6">
              ...
              <div class="form-group">
                <label for="Q3">3.- Empathy/rapport was attempted to be built</label>
              ...
              <div class="form-group">
                <label for="Q5">5.- Agent used effective questioning/probing skills.</label>
            ...
            <div class="col-md-6 col-lg-6 col-xl-6">
              ...
              <div class="form-group">
                <label for="Q7">7.- The agent sound confident /ownership of the call/?</label>
              ...
              <div class="form-group">
                <label for="Q8">8.- Did the agent rebuttal ?</label>
              ...
              <div class="form-group">
                <label for="Q10">10.- Agent demonstrated active listening.</label>
...
<script src="{{asset('/assets/js/Homeowners/liveSearchNames.js') }} "></script>
<script src="{{asset('/assets/js/Homeowners/scoresQA.js') }}"></script>
