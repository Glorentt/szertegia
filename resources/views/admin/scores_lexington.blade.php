...
<div class="row">
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
            <h1 class="main-title float-left"> <a href="{{route('admin.lexington.score')}} "> Scores</a></h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fa fa-table"></i> Lexington scores</h3>
...
<script>
    function showComments(val) {
        $.ajax({
            url: "getcommentsLexington/" + val, success: function (result) {
...
<script>
    $(document).ready(function () {
        var table = $('#scoreTable').DataTable({
            ...
            "ajax": {
                "url": "getScoresLexington/data.json/all"
            },
