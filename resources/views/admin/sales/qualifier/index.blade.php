...
<div class="row">
    <div class="col-xl-12">
        <div class="breadcrumb-holder">
            <h1 class="main-title float-left"> <a href="{{route('admin.forms.index')}} ">Qualifier</a></h1>
                    ...
                    <table id="salessTable" class="table table-borderless table-hover display" >
                        ...
                        <tbody class="blue-grey lighten-5">
                            ...
                            <tr id="{{$sale->id}}">
                                ...
                                <td width="7%">
                                    <form method="POST" action="{{route('admin.sales.qualifier.add')}} ">
                                ...
                                <td  style="padding-right: 0px; padding-left: 0px">
                                    <form method="POST" action="{{route('admin.sales.qualifier.minus')}} ">
                                        @csrf
                                        <input type="hidden" value="{{$sale->id}}" name="id"/>
