...
@section('title', 'All Scores Forex')
...
<div class="row">
    <div class="col-xl-12">
            <div class="breadcrumb-holder">
                    <h1 class="main-title float-left"> <a href="{{route('admin.forex.score')}} "> Scores</a></h1>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div class="card mb-3">
            <div class="card-header">
                <h3><i class="fa fa-table"></i>Forex scores</h3>
           ...
           <span aria-hidden="true">&times;</span>
             ...
             <div class="modal-body">
                <div class='row'>
                    ...
                    <div class='form-group col-md-6' >
                        <label for="Q3" class='text-primary'>3.- Agent offered further assistance at end of the call.</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q4" class='text-primary'>4.- Did the agent answer quickly and correctly? (less than 2 seconds).</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q5" class='text-primary'>5.- If the call was transferred did the agent adapt the greeting accordingly?</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q6" class='text-primary'>6.- Did the agent ask for / confirm the caller's information?</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q7" class='text-primary'>7.- The agent sound confident /focused?</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q8" class='text-primary'>8.- The agent took ownership of the call.</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q9" class='text-primary'>9.- Did the agent disposition correctly?</label>
                    </div>
                    <div class='form-group col-md-6' >
                        <label for="Q10" class='text-primary'>10.- Agent avoided long silences during the call?</label>
                    </div>
                </div>
                <div>
...
<script>
    function showComments(val) {
        $.ajax({url: "getcommentsForex/"+val, success: function(result){
...
<script>
    ...
    var table = $('#scoreTable').DataTable( {
        ...
        "ajax": {
            "url": "getScoresForex/data.json/all"
        },
        // "ajax": {
