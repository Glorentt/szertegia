...
class CreateCasemanagersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('casemanagers', function (Blueprint $table) {
          $table->increments('id');
          ...
          $table->integer('Q19')->unsigned();
          $table->integer('Q20')->unsigned();
          ...
          $table->string('C17',190)->nullable();
          $table->string('C18',190)->nullable();
          $table->string('C19',190)->nullable();
          $table->string('C20',190)->nullable();
    ...
    {
        Schema::dropIfExists('casemanagers');
    }
}
